"""Plot matrices
The code is adpated from https://github.com/birocoles/matcomp/blob/main/matcomp/plot_functions.py
"""
...
def plot_matrices(
    ...
    for i, matrix in enumerate(matrices):
        ...
        if same_scale is True:
            plt.matshow(matrix_masked, fignum=0, cmap=cmap, vmin=vmin, vmax=vmax)
        else:
